  ...
  if (!session?.user) {
    return (
      <View className="flex-1 bg-slate-50 items-center justify-center px-6">
        <Text className="text-slate-700 text-lg font-semibold mb-2">
          Not Signed In
        </Text>
        ...
        <Pressable
          ...
          className="bg-teal-600 rounded-xl px-8 py-3 active:bg-teal-700"
        >
  ...
  return (
    <ScrollView className="flex-1 bg-slate-50">
      ...
      <View className="px-4 pt-6">
        ...
        {meData?.organization && (
          <SettingsSection title="Organization">
            ...
            <SettingsRow
              ...
              onPress={isOwner ? undefined : undefined}
            />
          </SettingsSection>
        )}
        ...
        {isOwner && (
          <SettingsSection title="Inventory Management">
            <SettingsRow
              icon={Package}
              label="Products"
